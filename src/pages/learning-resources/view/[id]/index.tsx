...
import { getLearningResourceById } from 'apiSdk/learning-resources';
import { LearningResourceInterface } from 'interfaces/learning-resource';

function LearningResourceViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Learning Resource Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('learning_resource', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/learning-resources/edit/${id}`} passHref legacyBehavior>
                    <Button
